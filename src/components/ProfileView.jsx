...
export default function ProfileView({ user }) {
  ...
  return (
    <div className="animate-fadeIn w-full mx-auto space-y-5 font-sans pb-8">
      ...
      {/* 1. FUTURISTIC GLASSMORPHISM DIGITAL PASSPORT HEADER */}
      <div className="relative rounded-3xl bg-gradient-to-r from-slate-900 via-royal-950 to-slate-900 p-6 sm:p-8 text-white shadow-xl overflow-hidden border border-royal-500/30">
        
        {/* Holographic Glowing Background Orbs */}
        <div className="absolute top-0 right-0 w-80 h-80 bg-royal-600/20 rounded-full blur-3xl pointer-events-none"></div>
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-start space-y-4 sm:space-y-0 sm:space-x-6 text-center sm:text-left">
            <div className="relative">
              <img
                ...
                className="w-24 h-24 sm:w-28 sm:h-28 rounded-2xl object-cover ring-4 ring-royal-500/40 shadow-royal-glow bg-slate-900"
              />
              <span className="absolute -bottom-1.5 -right-1.5 p-1 bg-emerald-500 text-white rounded-xl shadow-md border-2 border-slate-900">
            ...
            <div className="space-y-1.5">
              <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2">
                <span className="px-3 py-0.5 rounded-lg text-[10px] font-black uppercase tracking-wider bg-royal-500/30 text-royal-200 border border-royal-400/40 font-mono">
                  {profileData.empId}
                </span>
                <span className="px-2.5 py-0.5 rounded-lg text-[10px] font-bold bg-emerald-500/20 text-emerald-300 border border-emerald-500/30 flex items-center space-x-1">
              ...
              <p className="text-xs sm:text-sm font-bold text-royal-300">
                {profileData.role}
              </p>

              <div className="flex items-center justify-center sm:justify-start space-x-2 text-xs text-slate-400">
                <Building className="w-3.5 h-3.5 text-royal-400" />
          ...
          <div className="w-full md:w-auto flex justify-center md:justify-end">
            <button
              ...
              className="w-full sm:w-auto px-5 py-2.5 rounded-xl bg-gradient-to-r from-royal-600 to-royal-800 hover:from-royal-500 hover:to-royal-700 text-white text-xs font-bold shadow-royal-glow transition-all flex items-center justify-center space-x-2"
            >
